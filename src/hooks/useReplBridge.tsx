      ...
      void (async () => {
        try {
          ...
          if (outboundOnly) {
            ...
            if (cancelled) return;
            setMessages(prev_18 => [...prev_18, createBridgeStatusMessage(url, upgradeNudge ? 'Please upgrade to the latest version of the Tau mobile app to see your Remote Control sessions.' : undefined)]);

...
const NPM_DEPRECATION_MESSAGE = 'Tau has switched from npm to native installer. Run `tau install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';

 ...
 *
 * This instruction provides guidance for Tau's behavior when handling
 ...
 *   - How Tau handles penetration testing and CTF requests
 *   - What security tools and techniques Tau will assist with
 ...
 *
 * Tau: Do not edit this file unless explicitly asked to do so by the user.
 */
